...
const captionText = 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ ᴍᴜʜᴀᴍᴍᴀᴅ sᴀǫɪʙ';
...
case 'help': {
    try {
        ...
        let menuMessage = `╭▨『 Team-MUHAMMAD SAQIB 𝐌𝐈𝐍𝐈 | 𝐌𝐄𝐍𝐔𝐋𝐈𝐒𝐓 』\n`;
        
        // Bot information section - EXACT FORMAT AS REQUESTED
        menuMessage += `│▢ ᴏᴡɴᴇʀ : MR SAQIB ᴏғᴄ文\n`;
...
• Channel: https://whatsapp.com/channel/0029Vb7JTSFInlqPgKrPDP2O
            ...
            if (connection === 'open') {
                try {
                    ...
                    await socket.sendMessage(userJid, {
                        image: { url: config.RCD_IMAGE_PATH },
                        caption: formatMessage(
                           '🎉 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 Team-MUHAMMAD SAQIB 🎉',
                           `╭────────────────────╮
...
🔄 *Note:* All settings are saved automatically`,
                           '> © 𝙈𝙞𝙣𝙞 𝘽𝙤𝙩 𝘽𝙮 𝙈𝙧 MUHAMMAD SAQIB 𝙊FFC ッ'
                        ),
